...
function parseLot(lot) {
    ...
    lotEntry.append("<th scope='row' style='position: relative'><h3>" + lotNumber + "<br>" +
        "<svg style='position: absolute; top: 50%' xmlns=\"http://www.w3.org/2000/svg\" width=\"32\" height=\"32\" fill=\"currentColor\" class=\"bi bi-star-fill clickable\" viewBox=\"0 0 16 16\">\n" +
